...
We do this by making the GitHub repository a [remote](../gloss.md#remote-repository)
...
Click on the 'HTTPS' link to change the [protocol](../gloss.md#protocol) from SSH to HTTPS.
...
and then look at the [timestamp](../gloss.md#timestamp) of the change on GitHub.
