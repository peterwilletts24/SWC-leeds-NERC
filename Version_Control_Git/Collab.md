...
We do this by making the GitHub repository a [remote](../gloss#remote-repository)
...
Click on the 'HTTPS' link to change the [protocol](../gloss#protocol) from SSH to HTTPS.
...
and then look at the [timestamp](../gloss#timestamp) of the change on GitHub.
