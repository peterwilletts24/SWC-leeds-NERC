...
Version control helps us manage these [conflicts](../gloss.md#conflict)
by giving us tools to [resolve](../gloss.md#resolve) overlapping changes.
...
[merge](../gloss.md#merge) them into the copy we're currently working in,
and then push that.
