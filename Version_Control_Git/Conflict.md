...
Version control helps us manage these [conflicts](../gloss#conflict)
by giving us tools to [resolve](../gloss#resolve) overlapping changes.
...
[merge](../gloss#merge) them into the copy we're currently working in,
and then push that.
