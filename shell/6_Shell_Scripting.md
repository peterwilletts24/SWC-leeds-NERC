...
a bunch of commands saved in a file is usually called a [shell script](../gloss.md#shell-script),
but make no mistake:
...
We can improve our script by adding some [comments](../gloss.md#comment) at the top:
