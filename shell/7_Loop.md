...
Instead, we can use a [loop](../gloss.md#for-loop)
...
the [variable](../gloss.md#variable) called `filename`.
Inside the loop,
...
The [loop body](../gloss.md#loop-body)
...
> by [quoting](../gloss.md#quoting) our use of the variable:
> 
> ~~~
> for filename in *.dat
> do
