...
Instead, we can use a [loop](../gloss#for-loop)
...
the [variable](../gloss#variable) called `filename`.
Inside the loop,
...
> by [quoting](../gloss#quoting) our use of the variable:
> 
> ~~~
> for filename in *.dat
> do
