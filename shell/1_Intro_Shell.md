...
[command-line interface](../gloss#command-line-interface), or CLI,
to distinguish it from the
[graphical user interface](../gloss#graphical-user-interface), or GUI,
that most people now use.
The heart of a CLI is a [read-evaluate-print loop](../gloss#read-eval-print-loop), or REPL:
