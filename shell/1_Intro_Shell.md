...
[command-line interface](../gloss.md#command-line-interface), or CLI,
to distinguish it from the
[graphical user interface](../gloss.md#graphical-user-interface), or GUI,
that most people now use.
The heart of a CLI is a [read-evaluate-print loop](../gloss.md#read-eval-print-loop), or REPL:
