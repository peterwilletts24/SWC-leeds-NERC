...
--help Print  a  usage  message  briefly summarising these command-line options and the bug-reporting
address, then exit.
...
> these is [regular expressions](../gloss.md#regular-expression), which
