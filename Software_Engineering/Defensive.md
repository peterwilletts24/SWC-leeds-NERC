...
This is called [defensive programming](../gloss.md.html#defensive-programming),
and the most common way to do it is to add [assertions](../gloss.md.html#assertion) to our code
...
-   A [precondition](../gloss.md.html#precondition) is something that must be true
 at the start of a function in order for it to work correctly.
-   A [postcondition](../gloss.md.html#postcondition) is something that
 the function guarantees is true when it finishes.
-   An [invariant](../gloss.md.html#invariant) is something that is always true
...
Writing assertions to check that you haven't [regressed](../gloss.md.html#regression)
...
is called [test-driven development](../gloss.md.html#test-driven-development) (TDD).
...
3. *Compare to an oracle.*
 A [test oracle](../gloss.md.html#test-oracle) is something&mdash;experimental data,
...
so re-running all of our tests tells us whether we have [regressed](../gloss.md.html#regression).
